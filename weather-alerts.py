...
if option == 'Historical Hurricanes/Storms':
    ...
    st.image('hurricane-michael-2018.png')
    ...
    st.image('hurricane-irma-2017.png')
    ...
    st.image('hurricane-harvey-2017.png')
    ...
    st.image('hurricane-wilma-2005.png')
    ...
    st.image('hurricane-katrina-2005.png')
